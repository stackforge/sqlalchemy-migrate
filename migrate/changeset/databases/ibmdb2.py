...
class IBMDBSchemaChanger(IBMDBSchemaGenerator, ansisql.ANSISchemaChanger):
    ...
    def visit_column(self, delta):
        ...
        if 'name' in keys:
            try:
                ...
                LOG.warn("Unable to change column %s" % delta.current_name)
        ...
        if column.primary_key:
            try:
                ...
                self.execute()
                    ...
                    print ("Continue since Primary key does not exist.")
    ...
    def _visit_column_change(self, table, col_name, delta):
        ...
        if column.primary_key:
            ...
            try:
                ...
                self.execute()
                    ...
                    print ("Continue since identity does not exist.")
        ...
        #data_type = delta.result_column.type.dialect_impl(
...
class IBMDBConstraintGenerator(ansisql.ANSIConstraintGenerator):
    def _visit_constraint(self, constraint):
        ...
        if (isinstance(constraint, UniqueConstraint) and
                is_server_version_at_least_10_5(self.dialect)):
